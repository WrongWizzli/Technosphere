...
void parse_file(std::ifstream& rd, std::vector<std::string>& links, std::map<std::string, std::set<int>>& word_links) {
        ...
        if (is_link) {
            ...
            if (wl > 0) {
                ...
                if (it == word_links.end()) {
                    word_links[word] = std::set<int>();
                }
                word_links[word].insert(links.size() - 1);
            }
        }
    }
}
...
std::set<int> get_urls(std::vector<std::string>& words, std::map<std::string, std::set<int>>& word_links) {
...
void read_request(std::vector<std::string>& links, std::map<std::string, std::set<int>>& word_links) {
...
int main(void) {
    ...
    std::map<std::string, std::set<int>> word_links;
